...
{
	Lcd_cursor(&lcd, 0,1);
	Lcd_string(&lcd, "YOGARAJ.S \n");
	Lcd_cursor(&lcd, 1,1);
	Lcd_string(&lcd, "212223040248 \n");
	for(int x=0;x<100;x++)
	{
		Lcd_cursor(&lcd,1,1);
		Lcd_int(&lcd,x);
...
## Output screen shots of proteus  :
 ![Screenshot 2024-09-13 145328](https://github.com/user-attachments/assets/116cbcec-47b1-41bd-b324-6042caab436d)
 
## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![Screenshot 2024-09-13 145351](https://github.com/user-attachments/assets/7e1f59dd-df75-40e5-bdc0-4fa1eda6bd5c)
